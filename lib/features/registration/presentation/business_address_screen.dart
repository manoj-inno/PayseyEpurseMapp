      ...
      providers: [
        BlocProvider(
          create: (context) => di.sl<GetAddressDetailsBloc>()
            ..add(GetAddressDetailsEvent.getAddressTypes(entityType: CustomerTypeIdentifier.corporate.value)),
        ),
                    ...
                    state.when(
                      ...
                      loaded: (registerAddress) {
                        context.navigateTo(RouteConstants.modeOfOperation,
                            arguments:
                                ModeOfOperationArguments(refNumber: widget.refNumber));
                      },
                      error: (message) {
                                                        ...
                                                        if (value == true) {
                                                          ...
                                                          if (latestPrimaryAddress
                                                              ...
                                                              latestPrimaryAddress
                                                                  .addressLine1
                                                                  .isNotEmpty) {
                                                            // First save the address data with the image path
                                                            if (latestPrimaryAddress
                                                                .addressProofImagePath
                                                                .isNotEmpty) {
                                                                    ...
                                                                    .add(
                                                                      SaveAddressData(
                                                                        ...
                                                                        addressTypeId:
                                                                            type.addressTypeId,
                                                                        addressProof:
                                                                            latestPrimaryAddress.addressProof,
                                                                        addressProofId:
                                                                            latestPrimaryAddress.addressProofId,
                                                                        addressProofIdNumber:
                                                                            latestPrimaryAddress.addressProofIdNumber,
                                                                        addressProofImage:
                                                                            existingImageFile,
                                                                        buildingName:
                                                                            latestPrimaryAddress.buildingName,
                                                                        addressLine1:
                                                                            latestPrimaryAddress.addressLine1,
                                                                        addressLine2:
                                                                            latestPrimaryAddress.addressLine2,
                                                                        city: latestPrimaryAddress
                                                                            .city,
                                                                        state: latestPrimaryAddress
                                                                            .state,
                                                                        postalCode:
                                                                            latestPrimaryAddress.postalCode,
                                                                        country:
                                                                            latestPrimaryAddress.country,
                                                                        clearImagePath:
                                                                            false,
                                                                      ),
                                                                    );
                                                              } else {
                                                                // If file doesn't exist, save without image
                                                                context
                                                                    .read<
                                                                        AddressManagementBloc>()
                                                                    .add(
                                                              ...
                                                              // If no image path, save without image
                                                              context
                                                                  .read<
                                                                      AddressManagementBloc>()
                                                                  .add(
                                                            ...
                                                            debugPrint(
                                                                '⚠️ No valid primary address found to copy');
                                                            // Reset checkbox if no valid data
                                                            setState(() {
                                                              _checkboxStates[
                                                                      index] =
                                                                  false;
                                                            ...
                                                            showErrorSnackBar(
                                                                context,
                                                                'Please fill the primary address first');
                                                          }
                                                        } else {
                                                          // If unchecked, emit an event to clear the address
                                                          debugPrint(
                                                              '🗑️ Removing address for type: ${type.addressTypeDesc}');
                                                          context
                                                              .read<
                                                                  AddressManagementBloc>()
                                                              .add(
