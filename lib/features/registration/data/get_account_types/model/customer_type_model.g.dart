...
_$CustomerTypeModelImpl _$$CustomerTypeModelImplFromJson(
        Map<String, dynamic> json) =>
    _$CustomerTypeModelImpl(
...
Map<String, dynamic> _$$CustomerTypeModelImplToJson(
        _$CustomerTypeModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
