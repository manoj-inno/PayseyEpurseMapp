...
abstract class $NotificationEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String body, DateTime timestamp});
}
...
class _$NotificationEntityImpl implements _NotificationEntity {
  ...
  @override
  String toString() {
    return 'NotificationEntity(id: $id, title: $title, body: $body, timestamp: $timestamp)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, title, body, timestamp);
...
abstract class _NotificationEntity implements NotificationEntity {
  const factory _NotificationEntity(
      ...
      required final DateTime timestamp}) = _$NotificationEntityImpl;
