...
mixin _$AccountTypeModel {
  ...
  /// Serializes this AccountTypeModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AccountTypeModel
...
/// @nodoc
abstract class _$$AccountTypeModelImplCopyWith<$Res>
    implements $AccountTypeModelCopyWith<$Res> {
  factory _$$AccountTypeModelImplCopyWith(_$AccountTypeModelImpl value,
          $Res Function(_$AccountTypeModelImpl) then) =
      __$$AccountTypeModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$AccountTypeModelImplCopyWithImpl<$Res>
    extends _$AccountTypeModelCopyWithImpl<$Res, _$AccountTypeModelImpl>
    implements _$$AccountTypeModelImplCopyWith<$Res> {
  __$$AccountTypeModelImplCopyWithImpl(_$AccountTypeModelImpl _value,
      $Res Function(_$AccountTypeModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AccountTypeModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$AccountTypeModelImpl implements _AccountTypeModel {
  const _$AccountTypeModelImpl(
      {required this.id,
  ...
  factory _$AccountTypeModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$AccountTypeModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'AccountTypeModel(id: $id, typeName: $typeName, description: $description, status: $status, processStatus: $processStatus, authStatus: $authStatus, createdTime: $createdTime, authTime: $authTime, createdUserId: $createdUserId, authUserId: $authUserId, deauthNarration: $deauthNarration)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AccountTypeModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AccountTypeModelImplCopyWith<_$AccountTypeModelImpl> get copyWith =>
      __$$AccountTypeModelImplCopyWithImpl<_$AccountTypeModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AccountTypeModelImplToJson(
      this,
    );
  }
}
...
abstract class _AccountTypeModel implements AccountTypeModel {
  const factory _AccountTypeModel(
      ...
      @JsonKey(name: 'deauth_narration')
      required final String deauthNarration}) = _$AccountTypeModelImpl;

  factory _AccountTypeModel.fromJson(Map<String, dynamic> json) =
      _$AccountTypeModelImpl.fromJson;
